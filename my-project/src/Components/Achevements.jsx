...
const Achievement = () => {
  return (
    <section className='w-full bg-white p-5'>
        <motion.div 
          className='md:max-w-[1100px] m-auto grid md:grid-cols-2 max-w-[400px]'
        ...
        >
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
                <img src="https://image.cnbcfm.com/api/v1/image/105248930-GettyImages-AB28744.jpg?v=1683812481" alt="hero" className='md:order-last m-auto order-first '/>
            </motion.div>
        </motion.div>
    </section>
  )
